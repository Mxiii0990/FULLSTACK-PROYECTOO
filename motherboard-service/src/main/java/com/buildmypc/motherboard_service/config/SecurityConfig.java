package com.buildmypc.motherboard_service.config;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, JwtAuthenticationConverter converter) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/motherboards/**", "/api/v2/motherboards/**")
                        .hasAnyRole("ADMIN", "TECNICO", "CLIENTE")
                        .requestMatchers("/api/v1/motherboards/**", "/api/v2/motherboards/**")
